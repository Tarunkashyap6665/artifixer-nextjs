          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <a href="#" className="text-white hover:bg-indigo-500 px-3 py-2 rounded-md text-sm font-medium">Pricing</a>
                <a href="#" className="text-white hover:bg-indigo-500 px-3 py-2 rounded-md text-sm font-medium">About</a>
                <a href="#" className="text-white hover:bg-indigo-500 px-3 py-2 rounded-md text-sm font-medium">Contact</a>
              </div>
            </div>
            <div className="hidden md:block">
