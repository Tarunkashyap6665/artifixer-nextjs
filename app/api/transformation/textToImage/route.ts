...
export async function POST(req: Request) {
    ...
    const url = 'https://8000-01j9vxs65b4343b00trw0c19zh.cloudspaces.litng.ai/predict';
    ...
    try {
      ...
      if(response.status==400){
        return NextResponse.json({ 
            title: "Bad Request", 
            result: "The prompt provided does not meet the required quality standards. Please refine and try again." 
          }, { status: 400 });
  ...
  export async function GET() {
    ...
    const url = 'https://8000-01j9vxs65b4343b00trw0c19zh.cloudspaces.litng.ai/health';
